...
export const metadata: Metadata = {
  title: 'Pricing | Reachful - Free AI Email Generator',
  description: 'Reachful is currently free to use! Generate personalized cold emails with AI research and commonality detection at no cost.',
  keywords: [
    'Reachful pricing',
  ...
  openGraph: {
    title: 'Pricing | Reachful - Free AI Email Generator',
    description: 'Reachful is currently free to use! Generate personalized cold emails with AI research.',
